...
- Prefer Skills over Task tool agents for token efficiency
- Skills run in main context (no separate agent spawn)
- Use Skill tool to invoke: `/map`, `/prime`, `/checkpoint`, `/commit`
- 60-80% token savings compared to Task tool agents
