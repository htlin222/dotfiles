...
- **Prefer Skills over Task agents** (60-80% token savings)
- Use direct tools (Grep, Read, Glob) for known paths/patterns
- Invoke skills via Skill tool: /commit, /map, /prime, /checkpoint
- Only spawn Task agents when parallelization benefit outweighs cost
- Avoid re-reading same files repeatedly within session
