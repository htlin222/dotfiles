...
tap "filebrowser/tap"
tap "freed-wu/undollar", "https://github.com/Freed-Wu/undollar"
tap "gromgit/fuse"
tap "happyrip/happy-tap"
...
# Analyze and clean your disk space (powered by Rust)
...
# Execute any shell command despite having a dollar sign at the beginning of the line.
brew "happyrip/happy-tap/undollar"
...
# Rust Cursive TUI that helps manage launchd jobs on macOS
brew "mach-kernel/pkgs/launchk"
...
cask "claude-code"
# Text expansion, screenshot & annotation, and clipboard management tool
cask "codeexpander"
# Audio player
cask "cog-app"
# Clipboard manager
...
cask "tomatobar"
# Hierarchical spreadsheet and outline application
cask "treesheets"
...
mas "Magnet Crop", id: 1547800025
mas "MarkEdit", id: 1669953820
mas "Notenik", id: 1465997984
mas "PDF Search", id: 1229271394
mas "Pocket", id: 568494494
mas "ProgrammableTooltip", id: 1495732622
mas "Prompt", id: 1483052809
mas "RunCat", id: 1429033973
mas "Table Tool", id: 1122008420
mas "Tempus Stopwatch", id: 1491326665
mas "Tot", id: 1491071483
mas "Vimari", id: 1480933944
mas "訂閱通", id: 1577082754
go "github.com/htlin/claude-tools/cmd/claude-hooks"
go "github.com/htlin/claude-tools/cmd/claude-statusline"
go "github.com/theredditbandit/pman"
go "github.com/wailsapp/wails/v2/cmd/wails"
cargo "add-gitignore"
cargo "add-gitignore-cli"
cargo "bk"
cargo "git-graph"
cargo "mdbook"
cargo "mdbook-theme"
...
npm "aicommits"
npm "apple-notifier-mcp"
npm "clawdbot"
npm "ctb"
npm "ffmpeg-progressbar-cli"
npm "happy-coder"
npm "http-server"
npm "llm-checker"
npm "mcp-zotero"
