...
**討論/延伸**：
- `Ctrl+R` 可重複按以循環搜尋結果
- 結合 [fzf](https://github.com/junegunn/fzf) 可獲得更強大的歷史搜尋（視覺化介面）
- 其他有用的歷史擴展：
  - `!n`：執行歷史中第 n 個命令
  - `!-n`：執行倒數第 n 個命令
...
[Tmux](https://github.com/tmux/tmux) 是一個終端多路器，提供會話管理、視窗分割等功能。
...
[Neovim](https://neovim.io/) 是 Vim 的現代分支，提供可擴展的編輯功能。
...
### Telescope ([fzf](https://github.com/junegunn/fzf) 整合)
...
[fzf](https://github.com/junegunn/fzf) 是一個強大的模糊搜尋工具，提供互動式的命令列搜尋體驗。
