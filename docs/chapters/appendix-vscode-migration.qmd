...
如果你習慣 [VS Code](https://code.visualstudio.com/)，這份指南幫助你逐步遷移到終端工作流。
...
| VS Code | Neovim |
|---------|--------|
| `Cmd+P` 開檔案 | `<leader>ff` ([Telescope](https://github.com/nvim-telescope/telescope.nvim)) |
| `Cmd+Shift+F` 全域搜尋 | `<leader>fg` 或 [ripgrep](https://github.com/BurntSushi/ripgrep) |
| 側邊欄檔案樹 | `<leader>e` ([nvim-tree](https://github.com/nvim-tree/nvim-tree.lua)) 或 [yazi](https://yazi-rs.github.io/) |
...
| `Cmd+/` 註解 | `gc` ([Comment.nvim](https://github.com/numToStr/Comment.nvim)) |
| `Cmd+Shift+K` 刪除行 | `dd` |
...
| 麵包屑導航 | [barbecue.nvim](https://github.com/utilyre/barbecue.nvim) |

### Git

| VS Code | 終端 |
|---------|------|
| Source Control 面板 | [lazygit](https://github.com/jesseduffield/lazygit) 或 `:Neogit` |
| Git blame | [gitsigns.nvim](https://github.com/lewis6991/gitsigns.nvim) |
| 差異檢視 | `:Gitsigns diffthis` 或 [lazygit](https://github.com/jesseduffield/lazygit) |
...
2. 每天用 [Neovim](https://neovim.io/) 編輯一個小檔案
3. 只學基本移動和編輯
...
- 參考 [Practical Vim](https://pragprog.com/titles/dnvim2/) 經典書籍
...
使用 [Telescope.nvim](https://github.com/nvim-telescope/telescope.nvim) 作為模糊搜尋引擎，結合 [ripgrep](https://github.com/BurntSushi/ripgrep) 進行全域搜尋。核心概念是：
- **Telescope**：統一的搜尋介面
...
**注意事項**：
- [Telescope](https://github.com/nvim-telescope/telescope.nvim) 需要安裝 [ripgrep](https://github.com/BurntSushi/ripgrep) 才能使用 `live_grep`：`brew install ripgrep`
- `<leader>` 通常設為空白鍵或逗號，在 `init.lua` 設定：`vim.g.mapleader = " "`
- Buffer 不會自動關閉，需要手動 `:bdelete` 或設定自動清理

**變體做法**：
- 使用 [fzf.vim](https://github.com/junegunn/fzf.vim) 替代 Telescope（更輕量）
- 使用 [harpoon](https://github.com/ThePrimeagen/harpoon) 管理常用檔案（類似書籤）
- 使用 [bufferline.nvim](https://github.com/akinsho/bufferline.nvim) 顯示視覺化 buffer 列表
...
1. 學習基本 [tmux](https://github.com/tmux/tmux) 操作
2. 設定 [vim-tmux-navigator](https://github.com/christoomey/vim-tmux-navigator)
3. 練習在 pane 間切換
...
使用 [tmux](https://github.com/tmux/tmux) 作為終端多工器，搭配 [vim-tmux-navigator](https://github.com/christoomey/vim-tmux-navigator) 實現無縫切換。核心概念是：
...
安裝並設定 [vim-tmux-navigator](https://github.com/christoomey/vim-tmux-navigator)（在 Neovim 和 tmux 間無縫移動）：
...
**變體做法**：
- 使用 [tmuxinator](https://github.com/tmuxinator/tmuxinator) 自動化 session 布局
- 使用 [tmux-resurrect](https://github.com/tmux-plugins/tmux-resurrect) 保存和恢復 session
- 改用 [zellij](https://zellij.dev/) 作為更現代的替代方案
...
1. 設定 LSP
2. 安裝 [lazygit](https://github.com/jesseduffield/lazygit)
3. 自訂快捷鍵
...
使用 [nvim-lspconfig](https://github.com/neovim/nvim-lspconfig) 設定 LSP，搭配自動完成插件。使用 [lazygit](https://github.com/jesseduffield/lazygit) 作為 Git 的 TUI（Text User Interface）。核心概念是：
...
在 Neovim 中整合 [lazygit](https://github.com/jesseduffield/lazygit)（`~/.config/nvim/lua/plugins/lazygit.lua`）：
...
**Lazygit 常用快捷鍵**（[lazygit](https://github.com/jesseduffield/lazygit) 官方文件）：
```
在 lazygit 介面中：
...
**變體做法**：
- 使用 [nvim-dap](https://github.com/mfussenegger/nvim-dap) 設定除錯功能（類似 VS Code debugger）
- 使用 [trouble.nvim](https://github.com/folke/trouble.nvim) 顯示診斷訊息列表
- 使用 [tig](https://github.com/jonas/tig) 替代 lazygit（更輕量但功能較少）
...
|------------------|-------------|
| Prettier | [conform.nvim](https://github.com/stevearc/conform.nvim) |
| ESLint | [nvim-lint](https://github.com/mfussenegger/nvim-lint) |
| GitLens | [gitsigns.nvim](https://github.com/lewis6991/gitsigns.nvim) |
| Copilot | [copilot.vim](https://github.com/github/copilot.vim) 或 [codeium.nvim](https://github.com/Exafunction/codeium.vim) |
...
- **Formatter**：使用 [conform.nvim](https://github.com/stevearc/conform.nvim) 統一管理格式化工具
- **Linter**：使用 [nvim-lint](https://github.com/mfussenegger/nvim-lint) 整合各種 linters
- **Git 整合**：使用 [gitsigns.nvim](https://github.com/lewis6991/gitsigns.nvim) 顯示 Git 狀態
- **AI 輔助**：使用 [copilot.vim](https://github.com/github/copilot.vim) 或開源替代方案
...
**進階設定**：
- 使用 [none-ls.nvim](https://github.com/nvimtools/none-ls.nvim)（原 null-ls）統一管理 formatters 和 linters
- 設定專案特定的格式化規則（`.prettierrc`、`.eslintrc`）
- 使用 [diffview.nvim](https://github.com/sindrets/diffview.nvim) 取得更好的 Git diff 體驗
...
A: 使用預設框架如 [NvChad](https://nvchad.com/) 或 [LazyVim](https://www.lazyvim.org/)，不要從零開始。
...
- **[tmux](https://github.com/tmux/tmux) session**：管理專案環境
- **[Neovim](https://neovim.io/)**：編輯程式碼
- **Git**：版本控制
- **終端工具**：執行命令和測試
...
使用 [tmuxinator](https://github.com/tmuxinator/tmuxinator) 定義專案布局（`~/.config/tmuxinator/myproject.yml`）：
...
**除錯流程**：
- 使用 `:Telescope diagnostics` 查看所有錯誤（[Telescope](https://github.com/nvim-telescope/telescope.nvim)）
- 使用 `]d` 和 `[d` 在錯誤間跳轉
...
- [Neovim 官方文件](https://neovim.io/doc/user/) - 完整參考手冊
- [Awesome Neovim](https://github.com/rockerBOO/awesome-neovim) - Neovim 插件彙總
