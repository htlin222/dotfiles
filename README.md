...
# setup the Edge as default browser && \
...
```shell
cd $HOME && git clone https://github.com/htlin222/dotfile.git .dotfile
```
#### or if you have installed gh
```shell
...
### Open iTerm
```shell
# install oh-my-zsh p10k zsh-autosuggestions zsh-syntax-highlighting zsh-vi-mode && \
...
```shell
# create venv for keyboardmaestro
pyenv virtualenv 3.10.5 keyboardmaestro
pip -r km_requrements.txt
pyenv deactivate keyboardmaestro 
...
* Alfred
  * [custom-alfred-iterm-scripts/custom_iterm_script.applescript at master · vitorgalvao/custom-alfred-iterm-scripts](https://github.com/vitorgalvao/custom-alfred-iterm-scripts/blob/master/custom_iterm_script.applescript)
* PDF expert
